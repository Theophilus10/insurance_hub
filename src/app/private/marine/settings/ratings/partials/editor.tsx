  ...
  return (
    ...
    >
      <div className="grid gap-4">
        <InputField name="coverType" label="Cover Type" type="text" />
        <InputField name="interest" label="Interest" type="text" />
        <InputField name="containerized" label="Containerized Rate" type="text" />
        <InputField name="nonContainerized" label="Non-Containerized Rate" type="text" />
        <InputField name="exclusions" label="Exclusions" type="text" />
